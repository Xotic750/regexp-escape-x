 ...
 */
"use strict";var requireCoercibleToString=_dereq_("require-coercible-to-string-x"),syntaxChars=/[\^$\\.*+?()[\]{}|]/g,replace="".replace;module.exports=function regExpEscape(string){return replace.call(requireCoercibleToString(string),syntaxChars,"\\$&")}},{"require-coercible-to-string-x":6}],2:[function(_dereq_,module,exports){
/**
